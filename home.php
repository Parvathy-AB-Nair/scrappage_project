<html>
<title>Scrappage Policy Automation</title>
<head>
...
<div class="news_events">
    <h4>Tips | Updates | Events</h4><br>
        <ul>
            <p>First, Register by scanning your RC book QR code. Then apply for scrappage of vehicle.
 </p><br>
    ...
    <div class="online_services">
        ...
        <ul>
            <a href="customer_reg_form.php"><li>User SignUp/Register</li></a>
            <a href="debit_card_form.php"><li>Godown Manager login </li></a><br>
